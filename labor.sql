...
CREATE TABLE `labor_wages`  (
  ...
  `tax` decimal(12, 2) NOT NULL DEFAULT 0.000000 COMMENT '税率',
  `tax_amount` decimal(12, 2) NOT NULL COMMENT '含税金额',
...
CREATE TABLE `labor_wages_import`  (
  ...
  `tax_amount` decimal(12, 2) NOT NULL COMMENT '含税金额',
  `type` tinyint NOT NULL DEFAULT 1 COMMENT '工资类型,实名制-1, 非实名制-2, 点工转账-3, 临设-4',
  `type_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '类型名称',
  `project_id` bigint NOT NULL COMMENT '项目部ID',
